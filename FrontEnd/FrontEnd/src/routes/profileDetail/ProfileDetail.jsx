...
const ProfileDetail = () => {
  const apiUrl = `http://3.144.46.39:8080/favoritos/rociomariacarrara@hotmail.com`;
  ...
  function eliminar(id, productoNombre) {
    if (
      confirm(
        `Está seguro que desea eliminar de favoritos a ${productoNombre}`
      )
    ) {
  ...
  return (
    <>
    <main style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', minHeight: '100vh', backgroundColor: '#1E1E1E', marginTop: '70px' }}>
       <article style={{ backgroundColor: 'rgb(30,30,30)', border: '1px solid #ccc', padding: '20px', borderRadius: '5px', boxShadow: '0px 2px 5px rgba(0, 0, 0, 0.1)', display: 'flex', justifyContent: 'space-between', width: '80%', height: '20px', alignItems: 'center' }}>
         <p style={{ margin: '0', flex: 1 }}>Nombre</p>
         <p style={{ margin: '0', flex: 1 }}>Apellido</p>
         <p style={{ margin: '0', flex: 1 }}>Email</p>
       </article>
       <article style={{ backgroundColor: 'rgb(30,30,30)', border: '1px solid #ccc', padding: '20px', borderRadius: '5px', boxShadow: '0px 2px 5px rgba(0, 0, 0, 0.1)', display: 'flex', justifyContent: 'space-between', width: '80%' }}>
         <p style={{ margin: '0', flex: 1 }}>{userData.firstname}</p>
         <p style={{ margin: '0', flex: 1 }}>{userData.lastname}</p>
         <p style={{ margin: '0', flex: 1 }}>{userData.username}</p>
       </article>
     
    <TableContainer component={Paper} style={{marginTop: '70px', border: '1px solid #ccc', borderRadius: '5px', width: '80%'}}>
